...
\begin{align}\label{eq:gaussian noise distribution}
	...
	&\nonumber= \frac{1}{\sqrt{2\pi (J^2 + \sigma^2)}}\exp\left[\frac{-s^2}{2(J^2+\sigma^2)}\right]\Big( 1 - \\ &\left.\cos\left[\frac{2ks\sigma^2}{J^2 + \sigma^2} + \phi \right]\exp\left[\frac{-2J^2k^2\sigma^2}{J^2 + \sigma^2}\right]\right).
\end{align}
