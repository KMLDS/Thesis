\chapter[Weak values and squeezed light]{Squeezed light enhanced weak values}\label{ch:squeezed}
...
shown in Fig.~\ref{fig:squeezedsetup}, we may combine the output of the dark port of a Rochester setup weak-value measurement with squeezed vacuum states. Coherent light prepared in a Gaussian mode from the laser is deflected by the piezo-mirror in the Sagnac interferometer.  The squeezed light source creates a squeezed vacuum prepared in a ``flipped'' Gaussian mode described below.  Though the coherent mode is deflected and the squeezed mode is not, this will only trivially affect the measurement provided the beam deflection is small compared to the beam width.     
...
%\begin{figure*}
%  \begin{center}
%    \centerline{\includegraphics[width=6in]{./figures/tnoisesnr.pdf}}
%  \end{center}
