\chapter{Improving measurement sensitivity through entanglement}\label{ch:biphotons}
...
\begin{figure}
	...
	\caption{Schematic for a biphoton displacement measurement.  
...
\begin{figure}
	...
	\caption{The probability distribution \eqref{eq:imperfectprofile} as a function of $x_1$ and $x_2$.  
...
\begin{figure}
	\includegraphics[scale=.9]{Biphotons/Figures/n_pixel_plot.pdf}
	\caption{A comparison of the Fisher information (in arbitrary units) due to biphoton pairs incident on detectors with different numbers of pixels $N$, using the numerical value $\sigma=1$ and $d=0.05$.
...
%\pagebreak\setcounter{equation}{0} \renewcommand{\theequation}{S\arabic{equation}} \onecolumngrid \setcounter{enumiv}{0}
...
\section*{Appendix B: Fisher information: quantum vs. classical}
